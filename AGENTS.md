...
balancing. Vultr and Bandwagon Reality remain available as manual diagnostic
nodes but are excluded from automatic groups while their OpenClash health
checks are failing.
...
- The R2-hosted profile includes Vultr Hysteria2 and Trojan as automatic paths,
  retains Vultr Reality for manual diagnosis, and includes the
